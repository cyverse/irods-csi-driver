...
ADD https://github.com/cyverse/irodsfs-pool/releases/download/${IRODSFS_POOL_VER}/irodsfs-pool-${IRODSFS_POOL_VER}-linux-amd64.tar.gz \
    /tmp/irodsfs-pool/irodsfs-pool.tar.gz
