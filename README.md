...
```sh
kubectl apply -f "examples/kubernetes/fuse_static_provisioning/storageclass.yaml"
```
...
```sh
kubectl apply -f "examples/kubernetes/fuse_static_provisioning/pv.yaml"
```
...
```sh
kubectl apply -f "examples/kubernetes/fuse_static_provisioning/pvc.yaml"
```
...
```sh
kubectl apply -f "examples/kubernetes/fuse_static_provisioning/app.yaml"
```
...
Delete Application:
```sh
kubectl delete --grace-period=0 --force -f "examples/kubernetes/fuse_static_provisioning/app.yaml"
```
